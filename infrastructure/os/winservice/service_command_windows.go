...
// installService attempts to install the harbid service. Typically this should
...
// removeService attempts to uninstall the harbid service. Typically this should
...
// startService attempts to Start the harbid service.
