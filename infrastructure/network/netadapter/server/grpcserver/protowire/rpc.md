...
GetCurrentNetworkRequestMessage requests the network harbid is currently running against.
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| payAddress | [string](#string) |  | Which harbi address should the coinbase block reward transaction pay into |
...
| ----- | ---- | ----- | ----------- |
| block | [RpcBlock](#protowire.RpcBlock) |  |  |
| isSynced | [bool](#bool) |  | Whether harbid thinks that it&#39;s synced. Callers are discouraged (but not forbidden) from solving blocks when harbid is not synced. That is because when harbid isn&#39;t in sync with the rest of the network there&#39;s a high chance the block will never be accepted, thus the solving effort would have been wasted. |
| error | [RPCError](#protowire.RPCError) |  |  |
...
GetPeerAddressesRequestMessage requests the list of known harbid addresses in the
...
currently connected to this harbid.
...
| isOutbound | [bool](#bool) |  | Whether this harbid initiated the connection |
| timeOffset | [int64](#int64) |  |  |
| userAgent | [string](#string) |  |  |
| advertisedProtocolVersion | [uint32](#uint32) |  | The protocol version that this peer claims to support |
| timeConnected | [int64](#int64) |  | The timestamp of when this peer connected to this harbid |
...
AddPeerRequestMessage adds a peer to harbid&#39;s outgoing connection list.
This will, in most cases, result in harbid connecting to said peer.
...
parent chain from some startHash to this harbid&#39;s current virtual
...
GetBlockCountRequestMessage requests the current number of blocks in this harbid.
...
ShutDownRequestMessage shuts down this harbid.
...
This call is only available when this harbid was started with `--utxoindex`
...
GetUtxosByAddressesRequestMessage requests all current UTXOs for the given harbid addresses
