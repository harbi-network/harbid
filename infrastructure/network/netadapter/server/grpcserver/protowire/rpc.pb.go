...
type GetBlockTemplateRequestMessage struct {
	...
	// Which harbi address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether harbid thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when harbid is not synced.
	// That is because when harbid isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this harbid initiated the connection
	...
	// The timestamp of when this peer connected to this harbid
