...
const (
	defaultConfigFilename      = "harbi.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "harbi.log"
	defaultErrLogFilename      = "harbi_err.log"
	...
	sampleConfigFilename    = "sample-harbi.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for harbid.
	DefaultAppDir = util.AppDir("har", false)
...
// Flags defines the configuration options for harbid.
//
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 24111, testnet: 24211)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 24110, testnet: 24210)"`
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in HAR/kB to be considered a non-zero fee."`
...
// Config defines the configuration options for harbid.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default harbid configuration
...
//
// The above results in harbid functioning properly without any config settings
...
// createDefaultConfig copies the file sample-harbid.conf to the given destination path,
