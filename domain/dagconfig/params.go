...
// Params defines a Harbi network by its parameters. These parameters may be
// used by Harbi applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/Harbipyi/research/issues/3
...
// MainnetParams defines the network parameters for the main Harbi network.
...
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "harbi-testnet-10",
	Net:         appmessage.Testnet,
	RPCPort:     "24210",
	DefaultPort: "24211",
	DNSSeeds: []string{
		"seeder1.harbitestnet.network",
	},
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixHarbiTest,
...
// SimnetParams defines the network parameters for the simulation test Harbi
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixHarbiSim,
...
// DevnetParams defines the network parameters for the development Harbi network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32Prefixharbidev,
...
// ErrDuplicateNet describes an error where the parameters for a Harbi
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Harbi network")

var registeredNets = make(map[appmessage.HarbipyiNet]struct{})

// Register registers the network parameters for a Harbi network. This may
