...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.LeorPerHarb
	defaultPreDeflationaryPhaseBaseSubsidy         = 4240 * 24 * 10 * constants.LeorPerHarb
	defaultDeflationaryPhaseBaseSubsidy            = 28 * constants.LeorPerHarb
	...
	defaultDeflationaryPhaseDaaScore = 50
