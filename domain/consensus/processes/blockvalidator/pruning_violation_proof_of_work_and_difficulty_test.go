...
import (
	...
	"github.com/harbi-network/harbid/domain/consensus/utils/blockheader"
	...
	"github.com/harbi-network/harbid/domain/consensus/utils/merkle"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		if consensusConfig.Name != "harbi-mainnet" {
