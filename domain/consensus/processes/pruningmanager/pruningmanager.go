...
import (
	...
	"github.com/harbi-network/harbid/domain/consensus/utils/multiset"
	"github.com/harbi-network/harbid/domain/consensus/utils/utxo"
	"github.com/harbi-network/harbid/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that harbid doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
