...
// SignatureScript creates an input signature script for tx to spend HAR sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend HAR sent
