...
harbi transaction scripts.

# Script Overview

Harbi transaction scripts are written in a stack-base, FORTH-like language.

The harbi script language consists of a number of opcodes which fall into
...
Typical harbi scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend harbi.
