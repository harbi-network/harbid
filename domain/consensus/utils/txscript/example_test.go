...
// This example demonstrates creating a script which pays to a harbi address.
...
func ExamplePayToAddrScript() {
	...
	// PayToAddrScript.
	addressStr := "harbi:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6u9aj94505"
	address, err := util.DecodeAddress(addressStr, util.Bech32PrefixHarbi)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func ExampleExtractScriptPubKeyAddress() {
	...
	// Output:
	// Script Class: pubkey
	// Address: harbi:qzy6cf82zzah2xh5jwtz8nx9u4gdj6zzke8gljs0v055ksmnl424uyf26y6h8
}
