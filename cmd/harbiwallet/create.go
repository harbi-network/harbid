...
import (
	...
	"github.com/harbi-network/harbid/cmd/harbiwallet/libharbiwallet/bip32"
	"github.com/harbi-network/harbid/cmd/harbiwallet/utils"
	"github.com/pkg/errors"

	"github.com/harbi-network/harbid/cmd/harbiwallet/keys"
)
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"harbiwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"harbiwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libharbiwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
