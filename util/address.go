...
import (
	"github.com/harbi-network/harbid/util/bech32"
...
const (
	...
	Bech32Prefixharbidev

	// Prefix for the test network.
	Bech32PrefixHarbiTest

	// Prefix for the simulation network.
	Bech32PrefixHarbiSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"harbi":     Bech32PrefixHarbi,
	"harbidev":  Bech32Prefixharbidev,
	"harbitest": Bech32PrefixHarbiTest,
	"harbisim":  Bech32PrefixHarbiSim,
}
...
// and a payload which encodes the harbi network and address type. It is used
