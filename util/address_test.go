...
func TestAddresses(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "harbi:qq2u4dvcpvdcn0k03afx0lgqhlj06kk0ay8std3t87tuexlhq7m87e4n078d6",
			encoded: "harbi:qq2u4dvcpvdcn0k03afx0lgqhlj06kk0ay8std3t87tuexlhq7m87e4n078d6",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixHarbi,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe9, 0xe3, 0x60, 0x8b, 0x11, 0xdb, 0x9b, 0x98, 0x16, 0xac,
					0x6b, 0x3b}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixHarbi)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixHarbi,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "harbi:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "harbi:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixHarbi,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixHarbi,
			expectedPrefix: util.Bech32PrefixHarbi,
		},
		{
			name:    "testnet p2pk",
			addr:    "harbitest:qph45l0y247vu078ktt3g0r0qefeqqqxrushmz4hlv2fjg6vfk3njk7pp4mh0",
			encoded: "harbitest:qph45l0y247vu078ktt3g0r0qefeqqqxrushmz4hlv2fjg6vfk3njk7pp4mh0",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixHarbiTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixHarbiTest)
			},
			passedPrefix:   util.Bech32PrefixHarbiTest,
			expectedPrefix: util.Bech32PrefixHarbiTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "harbi:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2sm7yrlr4w",
			encoded: "harbi:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2sm7yrlr4w",
			valid:   true,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixHarbi)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixHarbi,
		},
		...
		},
		{
			...
			addr:           "harbi:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixHarbi,
			expectedPrefix: util.Bech32PrefixHarbi,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "harbi:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "harbi:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixHarbi)
			},
			passedPrefix:   util.Bech32PrefixHarbi,
			expectedPrefix: util.Bech32PrefixHarbi,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "harbi:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "harbi:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixHarbi,
				[32]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixHarbi)
			},
			passedPrefix:   util.Bech32PrefixHarbi,
			expectedPrefix: util.Bech32PrefixHarbi,
		},
		{
			name:    "testnet p2sh",
			addr:    "harbitest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
			encoded: "harbitest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixHarbiTest,
				[32]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixHarbiTest)
			},
			passedPrefix:   util.Bech32PrefixHarbiTest,
			expectedPrefix: util.Bech32PrefixHarbiTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		//{
		//	"harbisim:qz830led3jg2wpym5nv8wfg6g3nz8cwt92zhc4azpzgjr6rz95nezuqmzj40a",
		//	util.Bech32PrefixHarbiSim,
		//	"unknown address type",
		//},
		//{
		//	"harbisim:raskzcg58mth0an",
		//	util.Bech32PrefixHarbiSim,
		//	"unknown address type",
		//},
		{
			"harbitest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
			util.Bech32PrefixHarbi,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"harbi", util.Bech32PrefixHarbi, false},
		{"harbitest", util.Bech32PrefixHarbiTest, false},
		{"harbisim", util.Bech32PrefixHarbiSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixHarbi, "harbi"},
		{util.Bech32PrefixHarbiTest, "harbitest"},
		{util.Bech32PrefixHarbiSim, "harbisim"},
		{util.Bech32PrefixUnknown, ""},
	}
