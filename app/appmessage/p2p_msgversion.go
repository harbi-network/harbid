...
import (
	...
	"github.com/harbi-network/harbid/util/mstime"
)
...
var DefaultUserAgent = fmt.Sprintf("/harbid:%s/", version.Version())

// MsgVersion implements the Message interface and represents a harbi version
...
// NewMsgVersion returns a new harbi version message that conforms to the
