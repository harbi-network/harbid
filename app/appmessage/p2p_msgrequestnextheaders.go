...
// MsgRequestNextHeaders implements the Message interface and represents a harbi
...
// NewMsgRequestNextHeaders returns a new harbi RequestNextHeaders message that conforms to the
// Message interface.
