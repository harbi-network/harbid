...
// harbi Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a harbi
// Addresses message.
...
// NewMsgAddresses returns a new harbi Addresses message that conforms to the
