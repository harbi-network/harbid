...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a harbi
...
// NewMsgDoneBlocksWithTrustedData returns a new harbi DoneBlocksWithTrustedData message that conforms to the
// Message interface.
