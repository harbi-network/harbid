...
// MsgRequestAddresses implements the Message interface and represents a harbi
...
// NewMsgRequestAddresses returns a new harbi RequestAddresses message that conforms to the
