...
// MsgRequestTransactions implements the Message interface and represents a harbi
...
// NewMsgRequestTransactions returns a new harbi RequestTransactions message that conforms to
