...
// MsgTransactionNotFound defines a harbi TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new harbi transactionsnotfound message that conforms to the
