...
// RPCTransaction is a harbid transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a harbid transaction input representation
...
// RPCScriptPublicKey is a harbid ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a harbid transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a harbid outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a harbid utxo entry representation meant to be used
// over RPC
