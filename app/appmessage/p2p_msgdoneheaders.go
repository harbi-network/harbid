...
// MsgDoneHeaders implements the Message interface and represents a harbi
...
// NewMsgDoneHeaders returns a new harbi DoneIBDBlocks message that conforms to the
// Message interface.
