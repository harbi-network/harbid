...
// MsgRequestAnticone implements the Message interface and represents a harbi
...
// NewMsgRequestAnticone returns a new harbi RequestPastDiff message that conforms to the
