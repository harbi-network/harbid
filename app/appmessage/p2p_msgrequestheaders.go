...
// MsgRequestHeaders implements the Message interface and represents a harbi
...
// NewMsgRequstHeaders returns a new harbi RequestHeaders message that conforms to the
