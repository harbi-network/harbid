...
// MsgRequestRelayBlocks implements the Message interface and represents a harbi
...
// NewMsgRequestRelayBlocks returns a new harbi RequestRelayBlocks message that conforms to
