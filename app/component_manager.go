...
import (
	...
	"github.com/harbi-network/harbid/app/rpc"
...
// ComponentManager is a wrapper for all the harbid services
...
// Start launches all the harbid services.
...
// Stop gracefully shuts down all the harbid services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("harbid is already in the process of shutting down")
		return
	}

	log.Warnf("harbid shutting down")
