...
import (
	...
	"github.com/harbi-network/harbid/infrastructure/network/rpcclient"
...
const miningAddress = "harbidev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownharbid := common.RunharbidForTesting(t, "harbid-daa-test", rpcAddress)
	defer tearDownharbid()
